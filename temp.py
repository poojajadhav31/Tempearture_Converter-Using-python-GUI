...
input_label = tk.Label(root, text="Enter temperature", background='#ADD8E6', foreground="#050505")
...
result_label1 = tk.Label(root, background='#ADD8E6', foreground="#050505")
result_label1.grid(row=3, columnspan=4)
result_label2 = tk.Label(root, background='#ADD8E6', foreground="#050505")
...
dropdown.config(background='#ADD8E6', foreground="#050505")
dropdown["menu"].config(background='#ADD8E6', foreground="#050505")

# button click
call_convert = partial(call_convert, result_label1, result_label2, numberInput)
result_button = tk.Button(root, text="Convert", command=call_convert, background='#ADD8E6', foreground="#050505")
